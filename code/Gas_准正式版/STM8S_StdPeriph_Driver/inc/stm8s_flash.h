...
/** @addtogroup FLASH_Exported_Constants
  ...
  */
//--------------------------------------------------------------
#define FLASH_PROG_START_PHYSICAL_ADDRESS ((uint32_t)0x008800) /*!< Program memory: start address */
#define FLASH_F_BACKUP_PHYSICAL_ADDRESS ((uint32_t)0x00C400) /*!< BACKUP memory: start address */
//--------------------------------------------------------------
...
//--------------------------------------------------------------
 #define FLASH_PROG_END_PHYSICAL_ADDRESS   ((uint32_t)0xC3FF)   /*!< Program memory: end address */
...
/**
  ...
  */
//---------------------------------------------------------
#define IS_FIRMWARE_ADDRESS_OK(ADDRESS)((((ADDRESS) >= FLASH_F_BACKUP_PHYSICAL_ADDRESS) && ((ADDRESS) <= FLASH_BACKU_END_PHYSICAL_ADDRESS)))
//---------------------------------------------------------
/**
...
void FLASH_Firmware(uint32_t Address, uint8_t Data);
/**
@code
