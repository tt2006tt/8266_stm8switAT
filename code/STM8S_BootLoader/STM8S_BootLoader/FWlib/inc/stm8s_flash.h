...
//--------------------------------------------------------------
#define FLASH_BOOT_START_PHYSICAL_ADDRESS ((uint32_t)0x008000) /*!< Program memory: start address */
#define FLASH_APP_START_PHYSICAL_ADDRESS ((uint32_t)0x008800) /*!< Program memory: start address */
#define FLASH_BACKUP_START_PHYSICAL_ADDRESS ((uint32_t)0x00C400) /*!< BACKUP memory: start address */
//--------------------------------------------------------------
//--------------------------------------------------------------
 #define FLASH_APP_END_PHYSICAL_ADDRESS   ((uint32_t)0xC3FF)   /*!< Program memory: end address */
 #define FLASH_BACKU_END_PHYSICAL_ADDRESS   ((uint32_t)0xFFFF)   /*!< Program memory: end address */
//--------------------------------------------------------------
 ...
 #define FLASH_APP_BLOCKS_NUMBER           ((uint16_t)136)
 #define FLASH_BACKUP_BLOCKS_NUMBER        ((uint16_t)256)
