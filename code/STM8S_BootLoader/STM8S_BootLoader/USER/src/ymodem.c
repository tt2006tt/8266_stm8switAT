...
/**
  ...
  *         1: abort by user
  */
static int8_t Receive_Packet (uint8_t *data, int32_t *length, uint16_t timeout)
{
            ...
            default:
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (FLASH_If_Write(&flashdestination,(uint32_t*)&packet_data[PACKET_HEADER], packet_length/4)  == 0)
                  {
                    Send_Byte(ACK);
                  }
